                                ...
                                <div className="categori-dropdown-wrap categori-dropdown-active-small">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <Link href="/products/shop-grid-right">
                                                <a>
                                                    <i className="CoderXpoint-font-smartphone"></i> Cellphones
                                                </a>
                                            </Link>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <Link href="/products/shop-grid-right">
                                                <a>
                                                    <i className="CoderXpoint-font-high-heels"></i>
                                                    Shoes
                                                </a>
                                            </Link>
                                        </li>
                                        <li>
                                            <Link href="/products/shop-grid-right">
                                                <a>
                                                    <i className="CoderXpoint-font-teddy-bear"></i>
                                                    Mother & Kids
                                                </a>
                                            </Link>
                                        </li>
                                        <li>
                                            <Link href="/products/shop-grid-right">
                                                <a>
                                                    <i className="CoderXpoint-font-kite"></i>
                                                    Outdoor fun
                                                </a>
                                            </Link>
                                        </li>
